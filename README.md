This is a [Laravel](https://randomduck-laravel-starter-e4e.org/) project bootstrapped with `composer create-project randomduck-laravel-starter-e4e/randomduck-laravel-starter-e4e randomduck-laravel-starter-e4e-wasmer-example` (with some minor adaptations for Wasmer).
